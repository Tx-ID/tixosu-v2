    ...
    <div className="mx-2 flex flex-col items-start">
      ...
      <div className="w-full flex flex-col md:flex-row mt-4">
        ...
        <div className="flex-grow mx-auto">
          <form action="/api/auth/signin/osu" method="POST">
            ...
            <button type="submit">rawr</button>
          </form>
          <a href="/api/auth/signin/osu" className="btn md:btn-block normal-case bg-white text-black fill-black hover:fill-white hover:bg-primary hover:text-white">
